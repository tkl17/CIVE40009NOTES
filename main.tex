...
%\title{CIVE40009: \\Geotechnics} % Title of the book
\title{%
  \:CIVE40009: \\Geotechnics \\
  \large  Engineering Geology \\
    }


\author[Truong Le]{} % Author

\publisher{\large   \:\:\: Dr. T. Le \\
                    Geotechnics \\
                    Room 534\\
                    truong.le@imperial.ac.uk} % Publisher
...
\par\smallcaps{     Dr. T. Le \\
                    Geotechnics \\
                    Room 534\\
                    truong.le@imperial.ac.uk
                    }
...
\par\textit{First printing, November 2023}
\end{fullwidth}
...
This course provides an introduction to the study of geotechnical engineering methods. The lecture notes will focus on providing students with a brief overview of engineering geology, a description of the principal rock types, as well as an introduction to geological cross-sections. These notes are designed for first-year undergraduate students of civil engineering. Students are assumed to start with no prior knowledge of geology but to have some understanding of the world beneath their feet, having lived on this planet for approximately two decades.

By the end of this course, students should have a better understanding of the possible ground conditions, rock types and geological processes which are commonly encountered around the world. The objective of these notes is to provide a good understanding of the basic principles of geology and how they relate to engineering. The contents of these lecture notes follow make frequent reference to .  
